...
Приложение работает с внешним тестовым REST-бэкендом и требует персональный токен. Есть два способа его задать:
...
Проект собирался итерациями: базовые экраны на Compose → работа с сетью → экран аналитики → архитектура, локальное хранилище и покрытие тестами. Бэкенд внешний, тестовый; данные на скриншотах не настоящие.
